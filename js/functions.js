        ...
        navigator.geolocation.getCurrentPosition(async (position) => {
            ...
            switch (weatherData.name) {
                ...
                case "Pori":
                    ...
                    break;
                case "Nakkila":
                    responseTertiary.innerHTML = `Ooks <span class="city-name">Nakkilas</span> vai, millai sää sin eksyit?`;
                    break;
                case "Rauma":
            ...
            switch (weatherQuery.value) {
                ...
                case "is-cold":
                    ...
                    if (weatherData.main.temp < 283.15) {
                        responseMain.innerHTML = "Juu";
                        responseAdditional.innerHTML = `Ulkon o <strong>${temperatureCelsius.toFixed(0)} °C</strong>.`;
                    } else {
                        responseMain.innerHTML = "Ei taid";
                        responseAdditional.innerHTML = `Ulkon o <strong>${temperatureCelsius.toFixed(0)} °C</strong> lämmint.`;
                    }
                    break;
                default:
                    break;
...
positiveFeedback.addEventListener("click", () => {
    ...
    responseAdditional.innerHTML = `On kai se ny ko mää ole se tehny.`;
